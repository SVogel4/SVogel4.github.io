...
try:
    ...
    print("Fehler beim Laden des GeoJSON:", e)
    # Fallback: leere FeatureCollection, damit das Skript nicht abstürzt
...
visited = {
    ...
    "Germany", "Austria", "Switzerland", "Italy", "France", "Turkey", "Luxembourg", "Spain"
}
